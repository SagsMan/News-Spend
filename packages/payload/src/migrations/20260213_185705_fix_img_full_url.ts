...
export async function down({
  ...
  DROP INDEX "media_sizes_mobile_sizes_mobile_filename_idx";
  ...
  ALTER TABLE "media" DROP COLUMN "sizes_mobile_url";
  ALTER TABLE "media" DROP COLUMN "sizes_mobile_width";
  ALTER TABLE "media" DROP COLUMN "sizes_mobile_height";
  ALTER TABLE "media" DROP COLUMN "sizes_mobile_mime_type";
  ALTER TABLE "media" DROP COLUMN "sizes_mobile_filesize";
  ALTER TABLE "media" DROP COLUMN "sizes_mobile_filename";`);
}
